...
export const saveCreditCustomer = (
  cond,
  cond2,
  cond3,
  cond4,
  ...
  return api2.post("/MICRM/CRM20_003INS.asmx/saveCreditCustomer", {
    USER_ID: cond,
    FLAG: cond2,
    SALECOMPCD: cond3,
    CUSTID: cond4,
...
export const saveCreditCustomer2 = (
  cond,
  cond2,
  cond3,
  cond4,
  ...
  return api2.post("/MICRM/CRM20_011INS.asmx/saveCreditCustomer2", {
    USER_ID: cond,
    FLAG: cond2,
    SALECOMPCD: cond3,
    CUSTID: cond4,
