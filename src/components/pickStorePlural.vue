  ...
  <div
    ...
    <div>
      <select
        ...
        class="w-56 h-7 rounded-lg mr-2"
    ...
    <div class="w-44">
      <div class="grid grid-rows-1 grid-cols-[6fr,1fr] w-44">
        ...
        <div>
          <button
            class="bg-blue-700 w-4 h-7 rounded-md"
            v-show="showStore"
            @click="showStoreList">
            <img
              src="../assets/white_arrow_up.png"
              alt=""
              class="w-32 bg-white" />
          </button>
        </div>
      ...
      <div
        class="z-30 absolute mt-9 bg-gray-200 w-[40%] h-8 right-5"
        v-if="showStore">
        <div
          ...
          <div class="text-center bg-black border rounded-lg p-1">
            <button class="text-white" @click="showOnlyChecked">
              선택매장확인
            </button>
          </div>
          <div class="text-center bg-black border rounded-lg p-1">
            <button class="text-white" @click="resetChecked">초기화</button>
          </div>
        </div>
      </div>
      <Realgrid
        v-if="showStore"
        class="!w-[40%] !h-[30%] z-30 absolute mt-16 right-5"
      ...
      <div class="grid grid-rows-1 grid-cols-2">
        ...
        <div>
          <select
            ...
            class="w-32 h-7 rounded-lg ml-2"
            :disabled="settingDisable == 1 || disabled1"
