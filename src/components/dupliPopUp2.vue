  ...
  <div
    ...
    <div class="bg-white w-[30%] h-[80%] shadow-lg rounded-lg flex flex-col">
      ...
      <main class="popup-body flex-grow">
        ...
        <div
          class="grid grid-cols-[1fr,4fr] border-gray-400 w-[25vw] ml-12 h-[6vh] mt-3 rounded-lg">
          <div
            class="border-[1px] border-gray-400 rounded-tl-md flex justify-center items-center">
            복사대상화면번호
          </div>
        ...
        <div class="w-[25vw] h-[30vh] ml-12 flex justify-center mt-[1vh]">
          <realgrid
            :progname="progname"
            :progid="progid"
            :rowData="rowData"
      ...
      <footer class="flex justify-end p-5 mt-1">
        <div
          class="border border-gray-300 rounded-md w-[5vw] h-[5vh] mr-7 -mt-8">
...
const showStoreList = async () => {
  ...
  try {
    ...
    if (searchWord.value == "") {
      ...
      rowData.value = res.data.storepos.filter(
        (item) =>
