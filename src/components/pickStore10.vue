    ...
    <div class="flex items-center justify-end space-x-3 text-xs ">
     <div class="font-bold text-sm pl-12 hidden md:inline-block"> 매장명 :  </div>
      ...
      <div class="flex justify-center items-center space-x-2">
        ...
        <label for="discount" class="flex justify-center items-center "><input type="radio" id="discount" v-model="paymentType" :value=1><span class="font-bold">[1]주문화면</span> </label> 
        <label for="payment" class="flex justify-center items-center"><input type="radio" v-model="paymentType" id="payment"  :value=8><span class="font-bold">[8]결제화면</span> </label> 
...
const emit = defineEmits(['update:storeGroup' , 'update:storeType' , 'update:storeCd', 'areaCd', 'posNo' ,'update:ischanged' ,'storeNm' , 'updatePaymentType']);
