<template>
  <div class="h-full" @click="handleParentClick">
    ...
    <div class="w-full h-[80%]">
      ...
      <Realgrid :progname="'ACT09_001RPT_VUE'" :progid="2" :rowData="rowData" :reload="reload" :setFooter="true"
...
const searchButton = async () => {
  ...
  try {
    ...
    const res = await getEmployeeSummary(selectedGroup.value, selectedStoreAttrs.value, selectedStores.value, selectedstartDate.value, selectedendDate.value, tranType.value, empId.value , lngOption.value , optionValue.value )
    console.log(res)
