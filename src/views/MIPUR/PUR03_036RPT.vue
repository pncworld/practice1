...
<template>
  ...
  <div class="h-full" @click="handleParentClick">
    ...
    <div
      ...
      <div class="flex justify-start pl-3 space-x-5 mt-2 items-center">
      ...
      <div class="flex justify-start pl-16 mt-1 items-center">
        <BusinessClient
      ...
      <div class="flex ml-12 items-center mt-3 space-x-5 text-nowrap">
        ...
        <div class="flex space-x-4">
          ...
          >
          <label for="cond52"
            ><input type="radio" v-model="cond6" id="cond52" value="1" />매장별
            자재별</label
          >
          <label for="cond53"
            ><input type="radio" v-model="cond6" id="cond53" value="2" />매장별
            일자별 자재별</label
          >
          <label for="cond54"
            ><input type="radio" v-model="cond6" id="cond54" value="3" />파트별
            자재별</label
          >
        </div>
      </div>
