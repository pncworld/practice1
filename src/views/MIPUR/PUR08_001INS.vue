<!-- /*--############################################################################
# Filename : PUR08_001INS.vue                                                  
# Description : 구매관리2 > 매장간 재고이동 관리 > 매장간 출고 등록                      
# Date :2025-09-23                                                             
# Author : 권맑음                     
################################################################################*/ -->
<template>
  ...
  <div class="h-full" @click="handleParentClick">
    ...
    <div
      ...
      <div class="justify-start flex ml-1 -mt-2">
        <Datepicker2
          :mainName="'이동기간'"
          @endDate="endDate"
          ref="datepicker"
      ...
      <div class="flex justify-start pl-12 ml-2 items-center space-x-5">
    ...
    <div class="w-full h-[75vh]">
      <div class="w-full h-[80%]">
        <Realgrid
          :progname="'PUR08_001INS_VUE'"
          :progid="1"
          :rowData="rowData"
          :setStateBar="false"
          :documentTitle="'PUR08_001INS'"
  ...
  <div
    ...
    <div class="bg-white rounded-lg w-[60vw] h-[65vh] p-5">
      <div class="flex justify-between">
        <h2 class="text-xl font-bold mb-4">매장간 출고 신규 등록</h2>
...
const searchButton = async () => {
  try {
    ...
    const res = await getStoreMoveList(
      groupCd.value,
      storeCode.value,
      storeCode2.value,
...
const searchButton2 = async () => {
  ...
  if (storeCode3.value == storeCode4.value) {
    Swal.fire({
      title: "경고",
...
const saveButton = async (e) => {
  try {
    ...
    const taxs = updatedrowdata2.value
      ...
      .join("\u200b");
    const res = await saveMoveStoreList(
      groupCd.value,
      storeCode3.value,
      storeCode4.value,
      scond3.value.replaceAll("-", ""),
...
const deleteButton = async () => {
  ...
  try {
    ...
    const res = await deleteStoreMoveList(
      groupCd.value,
      fromstorecd,
      moveseqids,
      tostorecd,
