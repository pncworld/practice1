...
<template>
  ...
  <div class="h-full" @click="handleParentClick">
    ...
    <div
      ...
      <div class="flex justify-start -ml-8 mt-2 items-center space-x-5">
      ...
      <div class="flex justify-start pl-16 mt-2 items-center">
        <BusinessClient
      ...
      <div class="flex ml-12 items-center mt-3 space-x-5 col-span-2">
        ...
        <div class="flex space-x-4">
          ...
          >
          <label for="cond52"
            ><input type="radio" v-model="cond5" id="cond52" value="1" />매장별
            자재별</label
          >
          <label for="cond53"
          ...
          >
          <label for="cond54"
            ><input type="radio" v-model="cond5" id="cond54" value="3" />파트별
            자재별</label
          >
        </div>
      </div>
...
import { getOrderListByType2, getOrderListByTypeByPart } from "@/api/mipur";
