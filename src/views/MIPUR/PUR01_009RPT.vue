<!-- /*--############################################################################
# Filename : PUR01_009RPT.vue                                                  
# Description : 구매관리2 > 발주 관리 > 조회유형별 매입현황                      
# Date :2025-08-28                                                             
# Author : 권맑음                     
################################################################################*/ -->
<template>
    ...
    <div
      ...
      <div class="flex ml-12 items-center mt-3 space-x-5 col-span-2">
        ...
        <div class="flex space-x-4">
          ...
          >
          <label for="cond54"
            ><input type="radio" v-model="cond5" id="cond54" value="3" />매장별
            일자별 자재별</label
          >
          <label for="cond55"
            ><input
