 ...
 <br>
   <div class="flex justify-start  space-x-5 bg-gray-200 rounded-lg md:h-16 h-24 items-center">
     ...
     <div class="">
        <span class="font-bold text-sm ">화면번호 : &nbsp;</span>
         <select class="w-32 text-sm border border-gray-800 rounded-md p-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" v-model="selectedScreenNo">
  ...
  <div v-if="showModifyScreenKey" class="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-[89]">
   ...
   <div class="grid grid-rows-[1fr,3fr,1fr,1fr,1fr,1fr,1fr,1fr,4fr,1fr] grid-cols-1 border border-gray-200 w-[25%] ml-20 rounded-lg" >
    ...
    <div class="flex justify-center items-center"><input type="text" class="border rounded-lg border-gray-200 px-2" v-model="clickedtableNm" @input="changetableProperty" :disabled="clickedtableNo==1"></div></div>
    <div class="grid grid-cols-2"><div class="bg-gray-100 font-semibold flex justify-center items-center">좌석 수</div>
    <div class="flex justify-center items-center"><input type="text" class="border rounded-lg border-gray-200 px-2" v-model="clickedtableSeats" @input="changetableProperty" :disabled="clickedtableNo==1"></div></div>
