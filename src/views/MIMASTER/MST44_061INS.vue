<template>
  ...
  <div class="flex justify-start  space-x-5 bg-gray-200 rounded-lg md:h-16 h-24 items-center">
    <PickStore @areaCd="handleStoreAreaCd" @update:storeCd="handleStoreCd" @posNo="handlePosNo" @storeNm="handlestoreNm"
      @update:ischanged="handleinitAll" :hidesub="hidesub"></PickStore>
  </div>
  <div class="z-50">
  ...
  <div class="mt-5 flex justify-start ml-10">
    <button class="contents_tab-button " :class="{ 'text-blue-600': currentMenu == false }"
      @click="showMenus(1)">KDS설정</button>
    <button class="contents_tab-button" :class="{ 'text-blue-600': currentMenu == true }" @click="showMenus(2)">매장별
      KDS설정</button>
  </div>
  <div class="flex h-4/6 w-full mt-5">
    ...
    <div class="flex flex-col w-3/5 h-4/6">
      <div class="flex justify-between mt-0 ml-10  border-b  border-b-gray-300"
        ...
        <div class="flex justify-start rounded-tl-lg text-xl -mt-1 font-bold " v-if="currentMenu == true">메뉴별 KDS 설정
        </div>
      ...
      <div class="h-4/6" v-show="currentMenu == false">
        <div class="ml-10 mt-5 w-full h-full">
          <Realgrid class="w-full h-[230%]" :progname="'MST44_061INS_VUE'" :progid="1" :rowData="rowData"
            :showGrid="showGrid" :showCheckBar="false" @selcetedrowData="selcetedrowData" :searchWord="searchword1"
            :searchColId="'lngCode,strName'" :addRow2="addRows" :addrowProp="'strName,kdsCornerNum'"
            :addrowDefault="addrowDefault" @updatedRowData="updatedRowData" @clickedRowData="clickedRowData"
            :deleteRow="deleteRows" :changeColid="'kdsCornerNm'" :changeRow="changeRow" :changeValue="changeValue"
      ...
      <div class="h-4/6 w-[80vw]" v-show="currentMenu == true">
        ...
        <div class="ml-10 mt-5 w-full h-full">
          <Realgrid class="w-[103%] h-[200%]" :progname="'MST44_061INS_VUE'" :progid="groupCd" :reload="reload"
            :rowData="rowData2" :showGrid="showGrid" :showCheckBar="false" @selcetedrowData="selcetedrowData"
            ...
            :editableColId="'strName'" :fixedColumn="fixedColumn"></Realgrid>
