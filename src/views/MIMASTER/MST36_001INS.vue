   ...
   <div class="grid grid-cols-1 grid-rows-[1fr,9fr] ml-20">
    ...
    <div>
      ...
      <option value="">선택</option>
          ...
          <div class="flex justify-center items-center border"><input type="date" max="9999-12-31" v-model="gridvalue7" name="dtmFromDate" @input="changeInfo" :disabled="afterClickrow" class="disabled:bg-gray-200"> ~ <input type="date" max="9999-12-31" v-model="gridvalue8" name="dtmToDate" @input="changeInfo" :disabled="afterClickrow" class="disabled:bg-gray-200"></div>
    ...
    <div class="flex justify-center items-center"><input type="text" name="lngChangeRateLimit" id="" class="h-full w-full border rounded-lg pl-2 disabled:bg-gray-200" v-model="gridvalue18" @input="changeInfo" :disabled="afterClickrow" ></div>
    ...
    <div class="flex justify-center items-center"><select name="lngRoundType" id="" class="border h-full w-full rounded-lg pl-2 disabled:bg-gray-200" v-model="gridvalue22" @change="changeInfo" :disabled="afterClickrow" >
      <option value="">선택</option>
    ...
    <div><input type="number" name="lngRound" id="" class="h-full w-full border rounded-lg pl-2 disabled:bg-gray-200" v-model="gridvalue23" @input="changeInfo"  :disabled="afterClickrow"></div>
    <div class="justify-center items-center bg-gray-100 border flex rounded-bl-lg">세금계산방법</div>
    <div class="flex justify-center items-center"><select name="lngTax" id="" class="border h-full w-full rounded-lg pl-2 disabled:bg-gray-200" v-model="gridvalue24" @change="changeInfo" :disabled="afterClickrow" >
      <option value="">선택</option>
    ...
    <div class="flex justify-center items-center"><select name="strIcon" id="" class="border h-full w-full rounded-lg pl-2 disabled:bg-gray-200" v-model="gridvalue25" @change="changeInfo"  :disabled="afterClickrow" >
      <option value="">선택</option>
