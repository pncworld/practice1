  ...
  <div class="flex ml-10 -mt-4 w-[60%] flex-row justify-between z-[88]">
    <div class="flex flex-row w-[79%]  items-center">
      ...
      <div class="flex gap-2 w-[1000px] z-[88] h-32 items-center relative overflow-hidden" ref="scrollContainer">
        <div v-for="(i, index) in ScreenKeyOrigin" :value="i.intScreenNo"
          class="bg-gray-100 rounded-lg w-[200px] h-10 flex-shrink-0 flex justify-center font-bold"
          :class="clickScreenButton == (i.intScreenNo) ? 'text-blue-800 border-blue-500 border-2' : 'black'">
          <button @click="showOtherScreen(i.intScreenNo)" class="w-[80%]">{{ i.strScreenName }}</button>
          <button @click="showModifyButton(index, i.intScreenNo)" class="w-[15%]"><img src="../../assets/ic_kebap.svg"
              alt=""></button>
          <div v-show="clickedShowModifyButton == index && showModifyButton2 == true"
    ...
    <div
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex justify-center items-center"><input type="text" class="border rounded-lg border-gray-200 px-2"
            v-model="clickedtableNm" @input="changetableProperty"></div>
      </div>
      <div class="grid grid-cols-2">
        <div class="bg-gray-100 font-semibold flex justify-center items-center">좌석 수</div>
        <div class="flex justify-center items-center"><input type="text" class="border rounded-lg border-gray-200 px-2"
            v-model="clickedtableSeats" @input="changetableProperty"></div>
      </div>
