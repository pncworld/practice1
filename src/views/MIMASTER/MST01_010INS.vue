<template>
  ...
  <span class="h-5 mt-3 flex justify-between items-center w-[900px] ml-[700px]  z-40">
    <h1 class="font-bold text-xl z-40">TLU 설정</h1><span class="flex space-x-3 ml-32 pl-56 items-center">순서변경 &nbsp;
      ...
      <div class="flex flex-col h-full ">
        <div class="mt-3 ml-10 grid grid-cols-[1fr,3fr] grid-rows-1 gap-0 w-full">
          ...
          <div class="px-1 py-1 border border-gray-300 rounded-br-lg "><input type="text"
              class="border w-full h-full px-1 border-gray-400 rounded-lg" @input="searchTLU" v-model="searchword">
          </div>
        </div>
        <div class="ml-10 mt-5 w-full h-full">

          <Realgrid class="w-full h-full mt-2" :progname="'MST01_010INS_VUE'" :progid="2" :rowData="TLUList"
            @clickedRowData="clickedRowData" :searchWord="searchword" :searchColId="'lngCode,strName'"
            ...
            :addRow4="addRow3" :addrowDefault="addrowDefault" :rowStateeditable="false" :editableColId="'strName'"
            :deleteRow2="deleteRow" :initFocus="initFocus" @updatedRowData="updatedRowData" :addField="'new'">
          </Realgrid>
        ...
        <div class="mt-3 ml-10 grid grid-cols-[1fr,3fr] grid-rows-3 gap-0 w-full">
          ...
          <div class="px-2 py-1 border border-gray-300 rounded-tr-lg flex gap-2 ">
            <select name="" id="" class="flex-1 border border-gray-300 rounded-lg " @change="setSubCd"
        ...
        <div class="ml-10 -mt-5 w-full h-full">
          ...
          <Realgrid class="w-full h-full mt-2" :progname="'MST01_010INS_VUE'" :progid="1" :rowData="filteredMenuList"
            @clickedRowData="clickedRowData3" :searchWord="searchword1" :searchColId="'lngCode,strName'"
            :searchColId2="'mainLngCode,subLngCode'" :searchColValue2="searchColValue2"
            @selcetedrowData="selcetedrowData" :selectionStyle="'singleRow'" :initFocus="initFocus"></Realgrid>
        ...
        <div class="flex w-full h-full ">
          <VueDraggableNext v-model="items" :move="onMove" @end="onEnd" animation="200"
            ...
            <div v-for="(item, index) in items" :key="index"
              ...
              @click="saveKey(index); clickedMenuKey = index" :disabled="item.inactivate == true">
              <span class="flex flex-col w-full h-20"><span class="mt-3">{{ item.lngCode ? item.lngCode : ''
                  }}</span><span>{{ item ? item.strName : '' }}</span><span class="flex justify-end pr-3">{{
