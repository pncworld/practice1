...
<div class="flex justify-center w-[80%] h-[70%] gap-5 ml-10 mt-5" >
    ...
    <div class="w-full h-full">
        ...
        <Realgrid class="w-full h-full mt-2" :progname="'MST01_008INS_VUE'" :progid="2" :rowData="filteredRowData2" :showGrid="showGrid" :showCheckBar="false" :addRow2="addbutton2" :addrowProp="'lngCode,lngMajor'" :deleteRow="deleterow2" :addrowDefault="addrowDefault" @selcetedrowData="selcetedrowData" :changeRow="changeRow" :changeColid="'strName'" :changeValue="changeValue2" @updatedRowData="updatedRowData" @clickedRowData="clickedRowData2" :editableColId="'strName'"  :exporttoExcel="exporttoExcel" :ExcelNm="'메뉴 분류 관리'" :deleteAll="deleteAll" :commitAll="commitAll"></Realgrid>
