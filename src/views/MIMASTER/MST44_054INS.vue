/*--############################################################################
# Filename : MST44_054INS.vue                                                  
# Description : 마스터관리 > POS 마스터 > 결제키 설정(#)                        
# Date :2025-05-14                                                             
# Author : 권맑음                     
################################################################################*/
<template>
  ...
  <div class="flex h-[65vh] w-full -mt-5">
    <div class="flex flex-col w-3/5 h-5/6">
      ...
      <div class="h-full" v-show="currentMenu == false">
        ...
        <div class="ml-10 -mt-9 w-full h-full">
          <Realgrid
            class="w-full h-full"
            :progname="'MST44_054INS_VUE'"
            :progid="1"
...
const onEnd = (evt) => {
  ...
  //comsole.log(KeyList.value);
  //comsole.log(currmenuKeyPage.value);
