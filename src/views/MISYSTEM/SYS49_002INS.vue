...
const rollBack = (e) => {
  ...
  //comsole.log(selectedUserSequence.value);
...
const clickedRowData2 = (e) => {
  ...
  //comsole.log(currentOriPassWord.value);
};
const clickedRowData = async (e) => {
  ...
  //comsole.log(e);
  //comsole.log(prevSequence.value);
  //comsole.log(updateRowData.value);
  //comsole.log(currentAddState.value);
...
const saveButton = async () => {
  ...
  //comsole.log(ori_validatePassWord);
  //comsole.log(value7.value);
  //comsole.log(selectedRowState.value);
...
const deleteRows = (e) => {
  ...
  //comsole.log(deleteRowSequences.value);
