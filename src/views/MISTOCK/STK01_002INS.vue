<!-- /*--############################################################################
# Filename : STK01_002INS.vue                                                  
# Description : 자재관리 > 청구 관리 > 청구 마감 관리               
# Date :2025-09-25                                                            
# Author : 권맑음                     
################################################################################*/ -->
<template>
  ...
  <div class="h-full" @click="handleParentClick">
    ...
    <div
      ...
      <div class="flex space-x-5 mt-2">
        <div class="font-semibold text-base">납기예정일</div>
        <div>
          <input
            type="text"
            class="w-20"
    ...
    <div class="w-full h-[82%]">
      <Realgrid
        :progname="'STK01_002INS_VUE'"
        :progid="1"
        :rowData="rowData"
        :reload="reload"
        :documentTitle="'STK01_002INS'"
...
const saveButton = async () => {
  try {
    ...
    const permissions = updatedrowdata.value
      ...
      .join("\u200b");
    const res = await saveDemCloseAndAuditList(
      store.state.userData.lngStoreGroup,
      cond.value,
