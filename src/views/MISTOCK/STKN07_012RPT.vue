<!-- /*--############################################################################
# Filename : STKN07_012RPT.vue                                                  
# Description : 자재관리 > 실사 관리 > 실사 조사 쉬트 발행.               
# Date :2025-08-07                                                            
# Author : 권맑음                     
################################################################################*/ -->
<template>
  ...
  <div class="h-full" @click="handleParentClick">
    ...
    <div
      ...
      <div class="h-[75%] ml-5 mt-2 flex flex-col">
        <PickStoreRenew
          @lngStoreCode="lngStoreCode"
          @excelStore="excelStore"
          :hideit2="false"
          :hideit="false"></PickStoreRenew>
        <div class="flex mt-4 items-center space-x-5 -ml-11">
    ...
    <div class="w-full h-[82%]">
      <Realgrid
        :progname="'STKN07_012RPT_VUE'"
        :progid="1"
        :rowData="rowData"
        :reload="reload"
        :documentTitle="'STKN07_012RPT'"
...
import { getStockDetail, getWorkSheetList } from "@/api/mistock";
...
const searchButton = async () => {
  ...
  try {
    ...
    const res = await getWorkSheetList(
