    ...
    <div class="grid grid-rows-1 grid-cols-[6.5fr,3.5fr] h-[80%] mt-5">
        <div><span class="flex justify-start">*영수내역을 선택하시면 상세내역을 확인할 수 있습니다.</span>
            <Realgrid :progname="'SLS02_011RPT_VUE'" :progid="1" :rowData="rowData" :valuesData="valuesData"
                ...
                @clickedRowData="clickedRowData" :initSelect="true" :exporttoExcel="exceloutput"
                :ExcelNm="'영수증별 매출 조회.'"></Realgrid>
        </div>
        <div class="grid grid-rows-3 grid-cols-1">
            <div>
                <span class="flex justify-start">고객 정보</span>
                <Realgrid :progname="'SLS02_011RPT_VUE'" :progid="2" :rowData="rowData2"></Realgrid>
            </div>
            <div class="mt-5">
                <span class="flex justify-start">주문 정보</span>
                <Realgrid :progname="'SLS02_011RPT_VUE'" :progid="3" :rowData="rowData3"></Realgrid>
            </div>
            <div class="mt-5">
                <span class="flex justify-start">결제 정보</span>
                <Realgrid :progname="'SLS02_011RPT_VUE'" :progid="4" :rowData="rowData4"></Realgrid>
            </div>
        </div>
    </div>
