    ...
    <div class="grid grid-rows-1 grid-cols-[7fr,3fr] h-[80%] mt-5">
        ...
        <div class="grid grid-rows-3 grid-cols-1">
            <div>
                ...
                <Realgrid :progname="'SLS02_011RPT_VUE'" :progid="2" :rowData="rowData2" :setStateBar="false"></Realgrid>
            </div>
            <div class="mt-5">
                <span class="flex justify-start">주문 정보</span>
                <Realgrid :progname="'SLS02_011RPT_VUE'" :progid="3" :rowData="rowData3" :setStateBar="false"></Realgrid>
            </div>
            <div class="mt-5">
                <span class="flex justify-start">결제 정보</span>
                <Realgrid :progname="'SLS02_011RPT_VUE'" :progid="4" :rowData="rowData4" :setStateBar="false"></Realgrid>
            </div>
        </div>
    </div>
