    ...
    <div class="h-full" @click="handleParentClick">
        ...
        <div class="grid grid-rows-2 grid-cols-2 justify-between  bg-gray-200 rounded-lg h-24 items-center z-10">
            ...
            <div class="-ml-[73%] mt-1">
                <PosList :groupCd="groupCd" :storeCd="storeCd" @posNo="posNo" @excelPosNo="excelPosNo" :init="init"></posList>
            </div>
        ...
        <div class="grid grid-rows-[1fr,1fr,2.5fr,1fr] grid-cols-1 h-[83%]">
            <div>
                ...
                <Realgrid :progname="'SLS02_028RPT_VUE'" :progid="1" :rowData="rowData" :reload="reload"
                    :exporttoExcel="exportExcel" :documentSubTitle="documentSubTitle" :documentTitle="'SLS06_005RPT'"
                    :getJson="getJson" @getJsonData="getJsonData">
            ...
            <div>
                ...
                <div class="flex justify-between h-[90%] mt-2 space-x-80">
                    <Realgrid :progname="'SLS02_028RPT_VUE'" :progid="2" :rowData="rowData2" :reload="reload"
                        :exporttoExcel="exportExcel" :documentSubTitle="documentSubTitle"
                        :documentTitle="'SLS06_005RPT'" :getJson="getJson" @getJsonData="getJsonData2">
                    </Realgrid>
                    <Realgrid :progname="'SLS02_028RPT_VUE'" :progid="5" :rowData="rowData5" :reload="reload"
                        :exporttoExcel="exportExcel" :documentSubTitle="documentSubTitle"
                        :documentTitle="'SLS06_005RPT'" :getJson="getJson" @getJsonData="getJsonData5">
                    </Realgrid>
                </div>
            ...
            <div>
                ...
                <div class="flex  justify-between h-[86%] space-x-80">
                    <Realgrid :progname="'SLS02_028RPT_VUE'" :progid="3" :rowData="rowData3" :getJson="getJson"
                        @getJsonData="getJsonData3"></Realgrid>
                    <Realgrid :progname="'SLS02_028RPT_VUE'" :progid="6" :rowData="rowData6" :getJson="getJson"
            ...
            <div>
                ...
                <div class="flex  justify-between h-[90%] space-x-80">
                    <Realgrid :progname="'SLS02_028RPT_VUE'" :progid="4" :rowData="rowData4" :getJson="getJson"
                        @getJsonData="getJsonData4"></Realgrid>
                    <Realgrid :progname="'SLS02_028RPT_VUE'" :progid="7" :rowData="rowData7" :getJson="getJson"
...
const excelButton = () => {
    ...
    setTimeout(() => {
        ...
        utils.sheet_add_aoa(ws, [['정산항목', '건수', '금액']], { origin: origin3 });
        ...
        utils.sheet_add_aoa(ws, [['메뉴그룹명', '건수', '금액']], { origin: origin7 });
        ...
        utils.sheet_add_aoa(ws, [['카드사명', '건수', '금액']], { origin: origin9 });
