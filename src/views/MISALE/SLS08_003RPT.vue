<template>
    <div class="h-full" @click="handleParentClick">
      ...
      <div class="grid grid-cols-2 grid-rows-1 justify-between  bg-gray-200 rounded-lg h-24 items-center z-10">
        <div class="grid grid-cols-1 grid-rows-3 mt-12">
          ...
          <div class="flex  justify-between items-center text-nowrap ml-40 -mt-2 ">
            <div class=" text-nowrap flex justify-start items-center space-x-10 ml-8 ">
            ...
            <div class="flex justify-end -space-x-5 mt-3 ml-[440px]">
      ...
      <div class="w-full h-[80%]">
        ...
        <Realgrid :progname="'SLS08_003RPT_VUE'" :progid="1" :rowData="rowData" :reload="reload" :setFooter="true" :mergeMask="mergeMask" :setMergeMode="false" :setGroupSumCustomColumnId="['dtmDate']" :setGroupSumCustomText="['소계']"
        :setGroupFooter="true" :setGroupColumnId="setGroupColumnId" :setGroupFooterExpressions="['sum','sum']" :setGroupFooterColID="['intCount','lngAmtCode']"
        :hideColumnsId="hideColumnsId" :setRowGroupSpan2="setRowGroupSpan" :setFooterExpressions="['sum','sum']" :setFooterColID="['intCount','lngAmtCode']"
          :documentTitle="'SLS08_003RPT'" :documentSubTitle="documentSubTitle" :exporttoExcel="exportExcel">
        </Realgrid>
      </div>
    </div>
  </template>
  ...
  <script setup>
  import { getCauseListbyMenu, getItemsCancelData, getMenusCancelData } from '@/api/misales';
