/*--############################################################################
# Filename : SLS08_003RPT.vue                                                  
# Description : 매출관리 > 매출 정정 현황 > 품목 취소 현황.                     
# Date :2025-05-14                                                             
# Author : 권맑음                     
################################################################################*/
<template>
  ...
  <div class="h-full" @click="handleParentClick">
    ...
    <div
      ...
      <div class="grid grid-cols-1 grid-rows-3">
        ...
        <div class="flex justify-between items-center text-nowrap ml-12 -mt-2">
          <div
            class="text-nowrap flex justify-start items-center space-x-5 ml-8">
          ...
          <div class="flex justify-end -space-x-7 mt-3 ml-[69.5%]">
    ...
    <div class="w-full h-[80%]">
      <Realgrid
        ...
        :setGroupFooterColID="['intCount', 'lngAmtCode']"
        :hideColumnsId="hideColumnsId"
        :setRowGroupSpan2="setRowGroupSpan"
        :setFooterExpressions="['sum', 'sum']"
        :setFooterColID="['intCount', 'lngAmtCode']"
        :documentTitle="'SLS08_003RPT'"
...
const searchButton = async () => {
  ...
  try {
    ...
    const res = await getItemsCancelData(
      selectedGroup.value,
