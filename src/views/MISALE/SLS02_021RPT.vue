<template>
    ...
    <div class="grid grid-rows-1 grid-cols-2 justify-between  bg-gray-200 rounded-lg h-14 items-center z-10">
        <div>
    ...
    <div class="grid grid-rows-1 grid-cols-1 h-[85%] mt-5">
        <Realgrid :progname="'SLS02_021RPT_VUE'" :progid="1" :rowData="rowData" :exporttoExcel="exporttoExcel" :documentTitle="'SLS02_021RPT'" :documentSubTitle="documentSubTitle">
...
const searchButton = async () => {
    ...
    try {
        ...
        const res = await getReceiptDataDetail(groupCd.value, storeCd.value, selectedStartDate.value, selectedEndDate.value)
        console.log(res)
