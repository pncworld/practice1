<template>
    ...
    <div class="flex justify-start  w-full pl-12 pt-4">
            ...
            <div class="grid grid-cols-2 grid-rows-1 justify-between  bg-gray-200 rounded-lg h-24 items-center z-10">
                  ...
                  <div><PickStorePlural @lngStoreCodes="lngStoreCodes" @lngStoreGroup="lngStoreGroup" @lngStoreAttrs="lngStoreAttrs"></PickStorePlural></div>
                  <div></div>
                ...
                <div class="w-full h-[85%]">
                  ...
                  <Realgrid :progname="'SLS06_004RPT_VUE'" :progid="progid" :rowData="rowData" :reload="reload" :setFooter="true" :setGroupFooter="setGroupFooter" :setFooterExpressions="setFooterExpressions" :setFooterColID="setFooterColID" ></Realgrid>
                </div>
</template>
...
const setFooterColID = ref(['lngRecCnt','lngRecAmt','lngCustCnt','lngCustAmt','lngSalAmt','lngDiscount','lngActAmt','lngVAT','lngSupplyAmt','dblDistRate'])
const setFooterExpressions = ref(['sum','avg','sum','sum','sum','sum','sum','sum','sum','sum'])
const progid = ref(1)
