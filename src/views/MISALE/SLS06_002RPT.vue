    ...
    <div class="flex justify-start  w-full pl-12 pt-4">
            ...
            <div class="grid grid-cols-2 grid-rows-1 justify-between  bg-gray-200 rounded-lg h-32 items-center z-10">
                ...
                <div class="w-full h-[85%]">
                  ...
                  <Realgrid :progname="'SLS06_004RPT_VUE'" :progid="progid" :rowData="rowData" :reload="reload" :setFooter="true" :setGroupFooter="setGroupFooter" :setFooterExpressions="setFooterExpressions" :setFooterColID="setFooterColID" :ExcelNm="'일자별 매출 현황.'" :exporttoExcel="exportExcel" :setGroupColumnId="'dtmDate'" :setGroupSumCustomText="'소계'" :setGroupSumCustomColumnId="'strWeekName'" :setGroupCustomLevel="1" :setGroupSummaryCenterIds="setGroupSummaryCenterIds"></Realgrid>
                </div>
</template>
