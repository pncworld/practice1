...
# Description : 매출관리 > 분류별 매출 현황 > 금액대별 매출현황.           
# Date :2025-07-15                                                             
# Author : 권맑음                     
################################################################################*/ -->
<template>
...
import { getSalesReportbyAmount } from "@/api/misales";
...
const searchButton = async () => {
  ...
  try {
    ...
    const res = await getSalesReportbyAmount(
      selectedGroup.value,
