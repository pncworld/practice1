 /*--############################################################################
# Filename : SLS11_017RPT.vue                                                  
# Description : 매출관리 > 상세 매출 현황 > 할인 세부 내역(메뉴별).                   
# Date :2026-06-09                                                             
# Author : 권지안                     
################################################################################*/
<template>
  ...
  <div class="h-full" @click="handleParentClick">
    ...
    <div class="w-full h-[80%]">
      <Realgrid
        ...
        :setRowGroupSpan="'lngReceipt,strEndTime,intCustCnt,lngTotAmount,lngTotDisAmount,lngTotActAmt'"
        :documentTitle="'SLS11_017RPT'"
...
<script setup>
import { getDiscountCodes, getDiscountRecordsByMenu } from "@/api/misales";
/**
 *  매출 일자 세팅 컴포넌트
 *  */
...
const searchButton = async () => {
  ...
  try {
    ...
    const res = await getDiscountRecordsByMenu(
      selectedGroup.value,
