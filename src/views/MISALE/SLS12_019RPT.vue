<template>
    <div class="h-full" @click="handleParentClick">
        ...
        <div class="grid grid-cols-2 grid-rows-1 justify-between  bg-gray-200 rounded-lg h-24 items-center z-10">
            <div class="grid grid-cols-1 grid-rows-2 mt-2 space-y-1">
                ...
                <div class="flex justify-center mr-20 -space-x-5">
                    <div class="text-base font-semibold ml-24 text-nowrap">결제코드 : </div>
                    <div class="flex justify-center ">
                        <v-select v-model="selectedCode" :options="codeList" placeholder="전체" label="strName"
                            class=" custom-select5 " clearable="true" @click="resetVselect2" />
        ...
        <div class="w-full h-[80%]">
            ...
            <Realgrid :progname="'SLS12_019RPT_VUE'" :progid="progid" :rowData="rowData" :reload="reload"
                :setFooter="true" :mergeMask="''" :setMergeMode="false" :setGroupFooter="setGroupFooter"
                :setGroupColumnId="setGroupColumnId" :setGroupCustomLevel="2"
                :setGroupSumCustomColumnId2="['lngStoreCode']" :setFooterCustomColumnId="['strStoreName']"
                :setFooterCustomText="['총합계']" :documentTitle="'SLS12_019RPT'" :documentSubTitle="documentSubTitle"
...
const searchButton = async () => {
    ...
    try {
        ...
        const res = await getSalesDetail(selectedGroup.value, selectedStoreAttrs.value, selectedStoreTeam.value, selectedStoreSuperVisor.value, selectedStores.value, selectedstartDate.value, selectedendDate.value, code)
        console.log(res)
