/*--############################################################################
# Filename : SLS08_005RPT.vue                                                  
# Description : 매출관리 > 매출 정정 현황> 과거 매출 변환 현황.                
# Date :2025-05-14                                                             
# Author : 권맑음                     
################################################################################*/
<template>
  ...
  <div class="h-full" @click="handleParentClick">
    ...
    <div
      ...
      <div class="grid grid-cols-1 grid-rows-3">
        ...
        <div class="flex flex-col justify-start items-start text-nowrap ml-14">
          <div
            class="text-nowrap flex justify-start items-center space-x-5 ml-5 mt-2">
        ...
        <div class="flex justify-start -space-x-7 ml-12 -mt-2">
