<template>
    <div class="h-full" @click="handleParentClick">
      ...
      <div class="w-full h-[80%]">
        ...
        <Realgrid :progname="'SLS08_002RPT_VUE'" :progid="1" :rowData="rowData" :reload="reload" :setFooter="true" :mergeMask="mergeMask" :setMergeMode="false" :setGroupSumCustomColumnId="['dtmDate']" :setGroupSumCustomText="['소계']"
        :setGroupFooter="true" :setGroupColumnId="setGroupColumnId" :setGroupFooterExpressions="['sum','sum']" :setGroupFooterColID="['intCount','lngActAmt']"
        :hideColumnsId="hideColumnsId" :setRowGroupSpan2="setRowGroupSpan" :setFooterExpressions="['sum','sum']" :setFooterColID="['intCount','lngActAmt']"
          :documentTitle="'SLS08_002RPT'" :documentSubTitle="documentSubTitle" :exporttoExcel="exportExcel">
        </Realgrid>
      </div>
    </div>
  </template>
