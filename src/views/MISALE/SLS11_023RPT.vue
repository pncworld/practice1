    ...
    <div class="w-full h-[82%]">
      <Realgrid
        ...
        :mergeColumnGroupSubList2="[
          ['lngCustDC', 'lngETCDC'],
          ['dtmFirstDate', 'dtmEndDate'],
        ]"
        :mergeColumnGroupName2="['할인액', '방문일시']"
        :documentTitle="'SLS11_023RPT'"
...
import { getCustSaleList } from "@/api/misales";
...
const searchButton = async () => {
  ...
  try {
    ...
    const res = await getCustSaleList(
      selectedGroup.value,
