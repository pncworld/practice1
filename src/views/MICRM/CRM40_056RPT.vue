<!-- /*--############################################################################
# Filename : CRM40_056RPT.vue                                                  
# Description : 고객관리 > 프로모션 관리 > 카카오 알림톡 발신 상세현황                     
# Date :2025-06-25                                                             
# Author : 권맑음                     
################################################################################*/ -->
<template>
  ...
  <div class="h-full" @click="handleParentClick">
    ...
    <div class="w-full h-[70vh]">
      <div class="w-full h-[90%]">
        <Realgrid
          :progname="'CRM40_056RPT_VUE'"
          :progid="1"
          :rowData="rowData"
          :reload="reload"
          :documentTitle="'CRM40_056RPT'"
...
<script setup>
import { getKakaoAlarmDetail, getReceiptEventList } from "@/api/micrm";
...
const searchButton = async () => {
  try {
    ...
    const res = await getKakaoAlarmDetail(
      groupCd.value,
      storeCode.value,
      storeAttr.value,
      supervisor.value,
