...
<template>
  ...
  <div class="h-full" @click="handleParentClick">
    ...
    <div
      ...
      <div class="justify-center flex items-center w-64 -space-x-32">
        <input
          type="checkbox"
          v-model="cond"
          class="pl-32 ml-96 z-[60]"
          @change="changeCond" />
        <Datepicker2
          :mainName="'기간'"
          @endDate="endDate"
...
<script setup>
import { getReceiptEventList } from "@/api/micrm";
...
const searchButton = async () => {
  ...
  try {
    ...
    const res = await getReceiptEventList(
      groupCd.value,
      storeCode.value,
      storeAttr.value,
      supervisor.value,
