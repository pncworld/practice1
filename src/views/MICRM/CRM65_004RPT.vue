...
<template>
  ...
  <div class="h-full" @click="handleParentClick">
    ...
    <div
      class="grid grid-cols-[1fr,1fr] grid-rows-2 bg-gray-200 rounded-lg h-24 items-center z-10 space-x-2 justify-start">
      ...
      <div class="justify-center flex items-center !mr-24">
        <span class="text-base font-semibold">구분 : </span>
        <select name="" id="" class="ml-4 w-40 h-8" v-model="cond2">
