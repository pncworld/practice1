...
/*
    ...
    strReqChannel: PAGE (usp_crmCustTIUD / Mod / New), WSVC (setMemberJoinExt), BFIL (가입일 백필)
...
(
    ...
    , @p_strReqChannel  VARCHAR(4)           /* PAGE | WSVC | BFIL */
...
BEGIN
    ...
    IF @p_strReqChannel NOT IN ('PAGE', 'WSVC', 'BFIL')
        RETURN;
